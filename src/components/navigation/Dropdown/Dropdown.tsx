...
export const Dropdown = ({
  ...
  return (
    ...
    >
      <div className="ms-dropdown-trigger" data-slot="menu-trigger">
        <button
          type="button"
      ...
      {open ? (
        <div className="ms-dropdown-menu" role="menu" data-slot="menu-panel">
          <div className="ms-dropdown-content" role="presentation" data-slot="menu-content">
