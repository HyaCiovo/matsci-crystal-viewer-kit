...
export const RangeSlider = ({
  ...
  return (
    <div id={id} className={clsx('ms-range-slider', className, { 'ms-no-ticks': !tickMarks })} data-slot="scrubber">
      <Input
      ...
      />
      <div className="ms-slider" style={styleSlider} data-slot="scrubber-track">
        <Slider.Root
